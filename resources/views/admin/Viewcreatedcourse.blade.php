...
<div style="display: flex;">   
  <!-- <v-userauth></v-userauth> -->
	...
	<!-- main side bar -->
      <v-asidebar home="{{route('home')}}" dashboard="" explore="{{route('explore')}}" settings="{{route('home')}}" faculty="{{route('manage-faculty')}}" createcourse="{{route('create-courses')}}" editcourse="{{route('view-created-course')}}" createuser="" user=""  active="course" activesub="editcourse"></v-asidebar>      
	<!-- end main side bar -->
