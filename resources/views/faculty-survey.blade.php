...
<div class="content">   		
        ...
        <br><br><br><br>	
     	...
     	<div class="px-4">
     		   <iframe src="https://forms.gle/FdDPVNiLvvKDaCou6" width="100%" style="border: none;background-position: center; background-size: 100px;background-repeat: no-repeat; background-image: url('/loading.gif'); height: 80vh;"></iframe>	
     	</div>
</div>
@endsection
