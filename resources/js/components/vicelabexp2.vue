          ...
          -->
            ...
            <div class="mainJ drag-drop scrollbar w-100"  id="mainSheet" >
                ...
                <div class="equipments drags dp-none" id="voltmeterRead" @mouseover="removeClass">
                  ...
                  <div class="picker equipments drags" style=" pointer-events:none; z-index: 0; display: none;width: 97% !important; box-shadow: none; height: 110% !important;" id="sunLight" >
                    
                  <img   src="/expImages/physics/exp1/lightModul.jpg" v-bind="attrs" v-on="on" @click='' width="100%">
                  <div class="cbtn">
                    <button class="deleteCell" rel="sunLight" style="position: relative; right: 50%;pointer-events: auto !important; " ><span><span style="color: #ba6;" class="fa fa-remove"></span></span></button>                    
                  </div>
                  </div>
               </div>
          </div>
