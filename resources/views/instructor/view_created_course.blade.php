...
<div style="display: flex;">   
  <!-- <v-userauth></v-userauth> -->
	...
	<!-- main side bar -->
      <!-- <v-asidebar home="{{route('home')}}" dashboard="" department="{{route('manage-department')}}" viewexperiment="{{route('view-created-experiment')}}" addexperiment="{{route('add-experiment')}}" explore="{{route('explore')}}" settings="{{route('home')}}"  faculty="{{route('manage-faculty')}}" createcourse="{{route('create-courses')}}" editcourse="{{route('view-created-course')}}" createuser="" user="{{route('manage-user')}}"  active="course" activesub="editcourse"></v-asidebar>  -->
      <v-isidebar active="course" activesub="editcourse"></v-isidebar>
